...
namespace STA.Data.MySql
{
    public partial class DataProvider : IDataProvider
    {
        ...
        public DataTable GetVotetopicDataPage(int pagecurrent, int pagesize, string condition, out int pagecount, out int recordcount)
        {
            return GetDataPage(BaseConfigs.GetTablePrefix + "votetopics", "id", pagecurrent, pagesize, "*", "id desc", condition, out pagecount, out recordcount);
        }
