...
{
    public partial class contentadd : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            hidAction.Value = "add";
            LoadPageControl();
            ConUtils.BulidChannelList(STARequest.GetInt("type", ctinfo.Id), Contents.GetChannelDataTable(), ddlConType);
        ...
        private void SaveInfo_Click(object sender, EventArgs e)
        {
            ...
            if (success)
            {
                ...
                ConUtils.InsertLog(2, userid, username, admingroupid, admingroupname, STARequest.GetIP(), (hidAction.Value == "add" ? "添加" : "编辑") + ctinfo.Name, string.Format(ctinfo.Name + "ID:{0},文档名:{1}", info.Id, info.Title));
            }
        ...
        private ContentInfo CreateInfo()
        {
            ...
            {
                info.Ext.Add(s, STARequest.GetString(s));
            }
            return info;
            #endregion
        }
