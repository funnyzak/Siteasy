...
{
    public partial class softlist : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                RedirectMessage();
                ViewState["condition"] = Contents.GetContentSearchCondition(3, "", 0, STARequest.GetQueryInt("chlid", 0), -1, "", "", "", "");
                BindData(1);
            }
        ...
        private void Del(int id)
        {
            ...
            InsertLog(2, "删除软件", string.Format("ID:{0},名称:{1}", id.ToString(), STARequest.GetFormString("name" + id.ToString())));
        }
        ...
        {
            string searchcondition = Contents.GetContentSearchCondition(3, txtUsers.Text, 0, TypeParse.StrToInt(ddlConType.SelectedValue, 0),
