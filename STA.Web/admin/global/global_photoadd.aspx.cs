...
namespace STA.Web.Admin
{
    public partial class photoadd : AdminPage
    {
        ...
        List<ContypefieldInfo> list = Contents.GetContypeFieldList(STARequest.GetInt("type", 2));
        ...
        private void LoadPageControl()
        {
            ...
            {
                if (Utils.InArray(info.Fieldname.Trim(), ContypefieldInfo.imglistfield.Split(','))) continue;
        ...
        private void LoadData(int id)
        {
            ...
            ext_style.SelectedValue = info.Ext["ext_style"].ToString();
        ...
        private void SaveInfo_Click(object sender, EventArgs e)
        {
            ...
            if (success)
            {
                ...
                ConUtils.InsertLog(2, userid, username, admingroupid, admingroupname, STARequest.GetIP(), (hidAction.Value == "add" ? "添加" : "编辑") + "图集", string.Format("图集ID:{0},图集名：{1}", info.Id, info.Title));
            }
        ...
        private ContentInfo CreateInfo()
        {
            ...
            if (hidAction.Value == "add")
            {
                ...
                info.Typeid = short.Parse(STARequest.GetInt("type", 2).ToString());
            }
