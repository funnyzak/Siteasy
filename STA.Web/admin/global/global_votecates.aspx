<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="global_votecates.aspx.cs" Inherits="STA.Web.Admin.votecates" %>
        ...
        <div id="mwrapper">
            <div id="main">
                        ...
                        <asp:Repeater ID="rptData" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="global_votecateadd.aspx?action=edit&id=<%#((DataRowView)Container.DataItem)["id"]%>">编辑</a>
                                        <a href="javascript:void(0)" onclick="SConfirm(function () { SubmitForm('delvotecate', <%#((DataRowView)Container.DataItem)["id"]%>); }, '删除后不可恢复，确认删除 <b><%#ReplaceJsComma(((DataRowView)Container.DataItem)["name"])%></b> 吗？');">删除</a>
                                    </td>
                                    <td>
                ...
                <div class="operate">
                    ...
                    <cc1:Button ID="Button6"  runat="server" AutoPostBack="false" ButtontypeMode="WithImage" ButtonImgUrl="../images/icon/add.gif" OnClientClick="location.href='global_votecateadd.aspx'" Text=" 投票分类添加" />
                </div>
            </div>
            <div id="footer">
                <%=footer %>
