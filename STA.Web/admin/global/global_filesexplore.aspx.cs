...
{
    public partial class filesexplore : AdminPage
    {
        public string currentvirtualpath = "";
        string fieldstr = string.Empty;
        private string currentPathCookieName = "admin_filesexplore_currentpath";
        private string rootPathCookieName = "admin_filesexplore_rootpath";
        private string currentActionCookieName = "admin_fileexplore_action";
        private string clipCookieName = "admin_filexplore_clipboard";
        ...
        public List<FileItem> BuildData()
        {
            ...
            currentvirtualpath = CurrentPath.Replace(Utils.GetMapPath("/"), "/").Replace('\\', '/');
        ...
        private string CurrentPath
        {
            get
            {
                ...
                if (currentpath == string.Empty)
                    return Utils.GetMapPath(BaseConfigs.GetSitePath + config.Attachsavepath + "/");
        ...
        {
            Message("当前文件夹：" + CurrentPath.Replace(Utils.GetMapPath("/"), "/").Replace('\\', '/') + "<br/>空间总占用：" + Utils.ConvertFileSize(FileUtil.GetDirectoryLength(CurrentPath)), 100);
        }
        #endregion
