<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="global_congroupadd.aspx.cs" Inherits="STA.Web.Admin.congroupadd" %>
...
<body style="overflow:hidden;">
    ...
    <div id="mwrapper" style="padding:0 7px 0 12px;overflow:hidden;">
        ...
        <div class="navbutton" style="text-align:center;">
            ...
            <cc1:Button runat="server" ID="SaveInfo" Text=" 保 存 组 "/>
        </div>
    </div>
    </form>
</body>
