...
{
    public partial class usergrouplist : AdminPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack && action != string.Empty)
            {
                ...
                {
                    case "delusergroup":
                        Users.DelUserGroup(STARequest.GetFormInt("hidValue", 0));
                        break;
                }
                hidAction.Value = "";
                LoadData();
        ...
        private void LoadData()
        {
            ...
            DataTable dt = Users.GetUserGroupDataPage(1, 10000, 0, out pageCount, out recordCount);
