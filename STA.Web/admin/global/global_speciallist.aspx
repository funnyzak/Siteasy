<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="global_speciallist.aspx.cs"Inherits="STA.Web.Admin.speciallist" %>
                    ...
                    <table class="top">
                        ...
                        <tr>
                            <td>
                                ...
                                <cc1:Button ID="btnSearch" runat="server" Text="搜索专题" />
                            </td>
                        </tr>
                    </table>
                </div>
...
<%--                                    <th>
                        ...
                        <ItemTemplate>
                            <tr tid="<%#((DataRowView)Container.DataItem)["id"]%>">
                                <td>
                                    <input type="checkbox" onclick="CheckedEnabledButton(this.form,'cbid','DelBtn','MakeHtmlBtn','ViewComment', 'EditBtn')" name="cbid" value="<%#Eval("id")%>" />
...
<%--                                <td>
                                ...
                                <td>
                                    <img alt="编辑属性" src="../images/trun.gif" title="编辑属性" id="fe<%#((DataRowView)Container.DataItem)["id"]%>" onclick="FastEditTr('../tools/fastcontentedit.aspx?type=-1&id=', <%#((DataRowView)Container.DataItem)["id"]%>, 11, '100%', '170');"/>
                                    <a title="编辑" href="<%#GetConAddPage(TypeParse.StrToInt(((DataRowView)Container.DataItem)["typeid"],1))%>&action=edit&id=<%#((DataRowView)Container.DataItem)["id"]%>&url=<%=Utils.UrlEncode(currentpage)%>"><img alt="编辑" src="../images/conedit.png" /></a>
                                    ...
                                    <a title="删除" href="javascript:void(0)" onclick="SConfirm(function () { SubmitForm('delcon', <%#((DataRowView)Container.DataItem)["id"]%>); }, '确认删除 <b><%#ReplaceJsComma(((DataRowView)Container.DataItem)["title"])%></b> 吗？');"><img alt="删除" src="../images/icon/del.gif" /></a>
    ...
    <script type="text/javascript">
        $("#AddContentBtn").click(function () { location.href = "global_specialadd.aspx?url=<%=Utils.UrlEncode(currentpage)%>"; });
        EditForList("EditBtn", Ele("form1"), "global_specialadd.aspx?url=<%=Utils.UrlEncode(currentpage)%>&action=edit&id=", true);
        ...
        function CheckAll(form, checked) {
            ...
            CheckedEnabledButton(form, 'cbid', 'DelBtn', 'MakeHtmlBtn', 'ViewComment', 'EditBtn')
        }
        ...
        $("#AddContentBtn").text(" 新增<%=ctinfo.Name%> ");
    </script>
</body>
</html>
