...
{
    public partial class flinkcls : AdminPage
    {
        ...
        private void LoadData(int pageIndex)
        {
            ...
            DataTable dt = Contents.GetLinkTypePage(pageIndex, managelistcount, out pageCount, out recordCount);
        ...
        {
            InsertLog(2, "删除链接分类", string.Format("ID为:{0},名称:{1}", id.ToString(), STARequest.GetFormString("name" + id.ToString())));
            return Contents.DelLinkType(id);
        }
