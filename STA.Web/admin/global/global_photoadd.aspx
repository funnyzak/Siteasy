<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="global_photoadd.aspx.cs" Inherits="STA.Web.Admin.photoadd" %>
...
<body>
        ...
        <div id="mwrapper">
                        ...
                        <table>
                            ...
                            <tr style="display: none;" id="trUrl" runat="server">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" onclick="if($.trim($('#txtUrl').val())==''){return}window.open($('#txtUrl').val(),'_blank')">
                                        打开</a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;" id="asource">选择</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 图集作者：<cc1:TextBox
                            ...
                            <tr>
                                ...
                                <td>
                                   <cc1:RadioButtonList runat="server" ID="ext_style" RepeatColumns="5" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="1" Selected="True">单页多图</asp:ListItem>
                                        <asp:ListItem Value="2">缩略图显示</asp:ListItem>
                                        <asp:ListItem Value="3">幻灯片显示</asp:ListItem>
                                   </cc1:RadioButtonList>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="itemtitle" style="padding-top:0;">
                                    图集内容:
                                </td>
                                <td style="padding-top:0;">
                                    <div class="inner-pad-2">
                                        <cc1:CheckBox runat="server" ID="cbIsFiterDangerousCode" Checked="false" HelpText="如果图集是从其他网站复制的，过滤隐藏脚本"
                                            Text="过滤不安全代码" />
                                        ...
                                        <cc1:CheckBox Checked="false" ID="cbIsRemote" runat="server" HelpText="把图集里的资源下载到本地服务器,建议勿下载有大件的资源否则保存会比较慢"
                                            Text="下载远程资源" />
            ...
            <div class="navbutton">
                ...
                <cc1:Button runat="server" ID="SaveInfo" ButtontypeMode="WithImage" ButtonImgUrl="../images/icon/state2.gif"
                    Text=" 保 存 图 集" AutoPostBack="false"/>
    ...
    <script type="text/javascript">
        ...
        $("#GoBack").click(function () { location.href = "global_photolist.aspx?type=<%=STARequest.GetString("type")%>"; });
        RegSelectFilePopWin("selectimgfile", "图集图片选择", "root=<%=filesavepath%>&filetype=jpeg,jpg,gif,png,bmp&fullname=1&cltmed=1&fele=txtImg", "click",$("#txtImg"));
        RegSelectFilePopWin("selecttemplate", "图集模版选择", "root=templates,<%=templatename%>,<%=config.Templatesavedirname%>&filetype=htm&fullname=0&cltmed=1&retsux=0&fele=txtTemplate&rename=0&query=content_", "click",$("#txtTemplate"));
        ...
        RegSelectFilePopWin("selectcolimgs", "图片选择", "root=<%=filesavepath%>&filetype=jpeg,jpg,gif,png,bmp&fullname=1&cltmed=5&cusmethod=SelectProductMethod", "click");
