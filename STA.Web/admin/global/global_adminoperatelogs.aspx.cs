...
{
    public partial class adminoperatelogs : AdminPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ViewState["condition"] = Users.GetAdminlogSearchCondition(2, "", "", "", "");
                LoadData(1);
            }
        ...
        private void EmptyAllBtn_Click(object sender, EventArgs e)
        {
            ...
            Message(Users.DelAdminlogWhere(Users.GetAdminlogSearchCondition(2,"","","","")) > 0);
            LoadData(TypeParse.ObjectToInt(ViewState["pageIndex"], 1));
        }
        ...
        {
            ViewState["condition"] = Users.GetAdminlogSearchCondition(2, txtStartDate.Text, txtEndDate.Text, txtUsers.Text.Trim().Replace(" ", ",").Replace("，", ","), txtKeywords.Text);
            LoadData(1);
        }
