...
{
    public partial class congroups : AdminPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ViewState["condition"] = Contents.GetConGroupSearchCondition(0, "");
                LoadData(TypeParse.ObjectToInt(ViewState["pageIndex"], 1));
            }
        ...
        private void LoadData(int pageIndex)
        {
            ...
            DataTable dt = Contents.GetConGroupDataPage(pageIndex, TypeParse.StrToInt(ViewState["pagesize"], managelistcount), TypeParse.ObjToString(ViewState["condition"]), out pageCount, out recordCount);
        ...
        {
            ViewState["condition"] = Contents.GetConGroupSearchCondition(0, txtKeywords.Text);
