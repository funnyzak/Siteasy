<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="global_specialadd.aspx.cs" Inherits="STA.Web.Admin.specialadd" %>
                    ...
                    <div class="box">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox runat="server" ID="txtAuthor" Width="200" />
                                    <a href="javascript:;" id="aauthor">选择</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%--                                    专题来源：<cc1:TextBox runat="server" ID="txtSource" Width="200" />
                                    <a href="javascript:;" id="asource">选择</a>--%>
                                </td>
                            </tr>
                            <tr>
                                <td class="itemtitle">
                    ...
                    <div class="box">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox runat="server" Text="special_default" ID="txtTemplate" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox runat="server" Text="specgroup_default" ID="ext_grouptpl" />
                                    <span id="selectspcegrouptpl" class="selectbtn">选择</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="itemtitle">
            ...
            <div class="navbutton">
                ...
                <cc1:Button runat="server" ID="SaveInfo" ButtontypeMode="WithImage" ButtonImgUrl="../images/icon/state2.gif"
                    Text=" 保 存 专 题 " AutoPostBack="false"/>
    ...
    <script type="text/javascript">
        ...
        $("#GoBack").click(function () { location.href = "global_speciallist.aspx?type=<%=STARequest.GetString("type")%>"; });
        RegSelectFilePopWin("selectimgfile", "专题图片选择", "root=<%=filesavepath%>&filetype=jpeg,jpg,gif,png,bmp&fullname=1&cltmed=1&fele=txtImg", "click",$("#txtImg"));
        
        RegSelectFilePopWin("selecttemplate", "专题模版选择", "root=templates,<%=templatename%>,<%=config.Templatesavedirname%>&filetype=htm&fullname=0&cltmed=1&retsux=0&fele=txtTemplate&rename=0&query=special_", "click",$("#txtTemplate"));
        RegSelectFilePopWin("selectspcegrouptpl", "专题内容组模版选择", "root=templates,<%=templatename%>,<%=config.Templatesavedirname%>&filetype=htm&fullname=0&cltmed=1&retsux=0&fele=ext_grouptpl&rename=0&query=specgroup_", "click",$("#ext_grouptpl"));
