...
<body>
        ...
        <div id="mwrapper">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;" id="asource">选择</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <%=ctinfo.Name%>作者：<cc1:TextBox
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <%=ctinfo.Name%>副频道：<cc1:TextBox runat="server" ID="txtExtChannels" Text=","/>
            ...
            <div class="navbutton">
                ...
                <cc1:Button runat="server" ID="SaveInfo" ButtontypeMode="WithImage" ButtonImgUrl="../images/icon/state2.gif"
                    Text=" 保 存 信 息 " AutoPostBack="false"/>
    ...
    <script type="text/javascript">
        ...
        RegSelectFilePopWin("selectimgfile", "<%=ctinfo.Name%>缩略图选择", "root=<%=filesavepath%>&filetype=jpeg,jpg,gif,png,bmp&fullname=1&cltmed=1&fele=txtImg", "click",$("#txtImg"));
        RegSelectFilePopWin("selecttemplate", "<%=ctinfo.Name%>模版选择", "root=templates,<%=templatename%>,<%=config.Templatesavedirname%>&filetype=htm&fullname=0&cltmed=1&retsux=0&fele=txtTemplate&rename=0&query=content_", "click",$("#txtTemplate"));
        ...
        //$("#SaveInfo").html(" <img src='../images/icon/state2.gif'/>  保存<%=ctinfo.Name%> ");
        ImgSetFileUpload({});
        ContAddOnSubmit("<%=ctinfo.Name%>");
    </script>
</body>
</html>
