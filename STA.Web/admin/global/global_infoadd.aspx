...
<body>
                        ...
                        <table>
                            ...
                            <tr style="display:none;">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;" id="asource">选择</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 信息作者：<cc1:TextBox
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="inner-pad-2">
                                        <cc1:CheckBox runat="server" ID="cbIsFiterDangerousCode" Checked="false" HelpText="如果信息是从其他网站复制的，过滤隐藏脚本"
                                            Text="过滤不安全代码" />
                                        ...
                                        <cc1:CheckBox Checked="false" ID="cbIsRemote" runat="server" HelpText="把信息里的资源下载到本地服务器,建议勿下载有大件的资源否则保存会比较慢"
                                            Text="下载远程资源" />
    ...
    <script type="text/javascript">
        ...
        RegSelectFilePopWin("selectimgfile", "信息图片选择", "root=<%=filesavepath%>&filetype=jpeg,jpg,gif,png,bmp&fullname=1&cltmed=1&fele=txtImg", "click",$("#txtImg"));
        RegSelectFilePopWin("selecttemplate", "信息模版选择", "root=templates,<%=templatename%>,<%=config.Templatesavedirname%>&filetype=htm&fullname=0&cltmed=1&retsux=0&fele=txtTemplate&rename=0&query=content_", "click",$("#txtTemplate"));
