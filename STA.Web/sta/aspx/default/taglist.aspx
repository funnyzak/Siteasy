...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	list = GetTable("tag", "num=" +  "10000" + " fields=id,name,count order=" +  "2" + "");
	...
	templateBuilder.Append("\r\n                    <li><a href=\"");
	templateBuilder.Append(siteurl.ToString());
	templateBuilder.Append("/tags.aspx?id=" + item["id"].ToString().Trim() + "&name=" + item["name"].ToString().Trim() + "\" target=\"_blank\" title=\"" + item["name"].ToString().Trim() + "\" class=\"s14 cdarkgrey underline\">" + item["name"].ToString().Trim() + "(<span class=\"cred\">" + item["count"].ToString().Trim() + "</span>)</a></li>\r\n                ");
	}	//end loop
