...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string pageguide = Paging(1,"id,savepath,filename,title,addtime,img,channelid,channelname,click,commentcount,content,ext_vipprice,ext_brand,ext_storage","",listcount,10,true,false,out datas);
	...
	templateBuilder.Append("</label>&nbsp;&nbsp;价格：<label class=\"cgrey\">" + item["ext_vipprice"].ToString().Trim() + "</label>元&nbsp;&nbsp;品牌：<label class=\"cgrey\">" + item["ext_brand"].ToString().Trim() + "</label>&nbsp;&nbsp;人气：<label class=\"cgrey\">" + item["click"].ToString().Trim() + "</label></p>\r\n                        <p class=\"desc cgrey s13\">");	templateBuilder.Append(Utils.GetUnicodeSubString(html,252,".."));
