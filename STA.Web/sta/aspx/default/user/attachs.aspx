<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="STA.Page.User.Attachs" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable flist = Contents.GetAttachmentDataPage("id,addtime,filename,description,filetype,fileext,filesize,attachment,downloads", page, 9, Contents.GetAttachSearchCondition("", "", username, "", -1, -1, ""), out pagecount, out recordcount);;
	...
	templateBuilder.Append("\r\n                            <tr>\r\n                                <td width=\"5%\" align=\"center\"><input type=\"checkbox\" name=\"cbid\" value=\"" + item["id"].ToString().Trim() + "\" onclick=\"checkedEnabledButton(this.form, 'cbid', 'btndelete')\"/></td>\r\n                                <td width=\"35%\" align=\"left\"><a href=\"");
	templateBuilder.Append(siteurl.ToString());
	templateBuilder.Append("" + item["filename"].ToString().Trim() + "\" title=\"" + item["attachment"].ToString().Trim() + "\" target=\"_blank\" class=\"cblue\">");	templateBuilder.Append(Utils.GetUnicodeSubString(item["attachment"].ToString().Trim(),56,".."));
	templateBuilder.Append("</a></td>\r\n                                <td width=\"7%\" align=\"center\" class=\"filetype\" ftype=\"" + item["fileext"].ToString().Trim() + "\">" + item["fileext"].ToString().Trim() + "</td>\r\n                                <td width=\"7%\" align=\"center\" rel=\"fsize\">" + item["filesize"].ToString().Trim() + "</td>\r\n                                <td width=\"15%\" align=\"center\"><span class=\"posttime cgrey\" title=\"");	templateBuilder.Append(Convert.ToDateTime(Convert.ToDateTime(item["addtime"].ToString().Trim())).ToString(" yyyy-MM-dd HH:mm:ss"));
	templateBuilder.Append("\"></span></td>\r\n                                <td width=\"7%\" align=\"center\">" + item["downloads"].ToString().Trim() + "</td>\r\n                            </tr>\r\n                            ");
	}	//end loop

	templateBuilder.Append("\r\n                        </tbody>\r\n                    </table>\r\n                	<div class=\"btn-manage\">\r\n                    	<input name=\"btndelete\" id=\"btndelete\" type=\"button\" class=\"button\" value=\"删除选中\" onclick=\"delAtts(getCbCheckedVals(),'");
	templateBuilder.Append(siteurl.ToString());
	templateBuilder.Append("/user/attachs.aspx')\" disabled=\"disabled\"/>&nbsp;\r\n                    </div> \r\n		            <script type=\"text/javascript\">\r\n		                $(function () {\r\n		                    $(\"table.list tr:even\").css({ \"background-color\": \"#f8f8f8\" });\r\n		                    $(\"span.posttime\").timeago();\r\n		                    $(\".filetype\").each(function () { $(this).html(getFileExtStr($(this).attr(\"ftype\")) + \" [\" + $(this).attr(\"ftype\") + \"]\"); });\r\n		                    $(\"td[rel=fsize]\").each(function (idx) { $(this).html(convertSize(parseInt($(this).html()))); });\r\n		                });\r\n		                function checkAll(form, checked) {\r\n		                    checkByName(form, 'cbid', checked);\r\n		                    checkedEnabledButton(form, 'cbid', 'btndelete')\r\n		                };\r\n                    </");
	templateBuilder.Append("script>\r\n                    ");
	}	//end if
	...
	string pagenumbers = PageNumber(siteurl+"/user/attachs.aspx",siteurl+"/user/attachs.aspx?page=@page",page,pagecount,recordcount,7, false).ToString();
