<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="STA.Page.User.Syspm" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable msglist = STA.Data.PrivateMessages.GetAnnouncePrivateMessageDataPage("",page,7,out pagecount,out recordcount);;
	
	templateBuilder.Append("\r\n                <form name=\"zform\" id=\"zform\" action=\"\" method=\"post\">\r\n                    ");
	if (msglist.Rows.Count<=0)
	{

	templateBuilder.Append("\r\n                    <div class=\"zerotable\">暂无系统信息</div>\r\n                    ");
	}
	else
	{
	...
	templateBuilder.Append(tempurl.ToString());
	templateBuilder.Append("/images/pub/announcement.gif\"/></td>\r\n                                <td  width=\"40%\" align=\"\"><a href=\"javascript:;\" class=\"cblue viewinfo\" mid=\"" + item["id"].ToString().Trim() + "\">" + item["subject"].ToString().Trim() + "</a>\r\n                                <div style=\"display:none\" mid=\"" + item["id"].ToString().Trim() + "\">\r\n                                ");	string message = Utils.HtmlDecode(item["content"].ToString().Trim());
	
	templateBuilder.Append("\r\n                                ");
	templateBuilder.Append(message.ToString());
	templateBuilder.Append("\r\n                                </div>\r\n                                </td>\r\n                                <td width=\"20%\" align=\"center\" class=\"cgrey\"><span class=\"posttime\" title=\"");	templateBuilder.Append(Convert.ToDateTime(Convert.ToDateTime(item["addtime"].ToString().Trim())).ToString(" yyyy-MM-dd HH:mm:ss"));
	...
	string pagenumbers = PageNumber(siteurl+"/user/syspm.aspx",siteurl+"/user/syspm.aspx?page=@page",page,pagecount,recordcount,7, false).ToString();
