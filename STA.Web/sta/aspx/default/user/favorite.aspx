<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="STA.Page.User.Favorite" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n    <div class=\"left right-container\">\r\n    	<div class=\"con-box left col-1\">\r\n        	<div class=\"bartitle clearfix\"><div class=\"bartit-picon left\" style=\"background-position:-235px -0;\">&nbsp;</div><h3 class=\"disblock left pad\">我的收藏</h3></div>\r\n            <div class=\"con-info\">\r\n                ");	int page = STARequest.GetQueryInt("page",1);
	...
	templateBuilder.Append("\r\n                            <tr>\r\n                                <td width=\"5%\" align=\"center\"><input type=\"checkbox\" name=\"cbid\" value=\"" + item["cid"].ToString().Trim() + "\" onclick=\"checkedEnabledButton(this.form, 'cbid', 'btndelete')\"/></td>\r\n                                <td width=\"3%\" align=\"center\"><img src=\"");
	templateBuilder.Append(tempurl.ToString());
	...
	templateBuilder.Append("\r\n                        </tbody>\r\n                    </table>\r\n                	<div class=\"btn-manage\">\r\n                    	<input name=\"btndelete\" id=\"btndelete\" type=\"button\" class=\"button\" value=\"删除选中\" onclick=\"delFavorites(getCbCheckedVals(),1,'");
	templateBuilder.Append(siteurl.ToString());
	templateBuilder.Append("/user/favorite.aspx')\" disabled=\"disabled\"/>&nbsp;\r\n                    </div> \r\n		            <script type=\"text/javascript\">\r\n		                $(function () {\r\n		                    $(\"table.list tr:even\").css({ \"background-color\": \"#f8f8f8\" });\r\n		                    $(\"span.posttime\").timeago();\r\n		                });\r\n		                function checkAll(form, checked) {\r\n		                    checkByName(form, 'cbid', checked);\r\n		                    checkedEnabledButton(form, 'cbid', 'btndelete')\r\n		                };\r\n                    </");
	templateBuilder.Append("script>\r\n                    ");
	}	//end if
	...
	string pagenumbers = PageNumber(siteurl+"/user/favorite.aspx",siteurl+"/user/favorite.aspx?page=@page",page,pagecount,recordcount,7, false).ToString();
