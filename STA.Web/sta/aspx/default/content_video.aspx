...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("</h1>\r\n                    <div class=\"summary\">\r\n                        <span class=\"copyright\">版权方：" + info.Ext["ext_copyright"].ToString().Trim() + "</span>\r\n                        <span class=\"source\">来源：");
	templateBuilder.Append(info.Source.ToString().Trim());
	templateBuilder.Append("</span>\r\n                        <span class=\"time\">发布时间：");	templateBuilder.Append(Convert.ToDateTime(Convert.ToDateTime(info.Addtime)).ToString(" yyyy-MM-dd HH:mm:ss"));
	...
	templateBuilder.Append("\r\n                    </div>\r\n                </div>\r\n                <div class=\"pcontent\">\r\n                    ");
	if (info.Ext["ext_vfile"].ToString().EndsWith(".mp4")||info.Ext["ext_vfile"].ToString().EndsWith(".flv"))
	{

	templateBuilder.Append("\r\n                    <div style=\"width:100%;padding-bottom:15px;\" id=\"vdobox\"></div>\r\n                    <script type=\"text/javascript\">\r\n                        videoPlay(\"vdobox\", \"" + info.Ext["ext_vfile"].ToString().Trim() + "\", \"");
	templateBuilder.Append(info.Img.ToString().Trim());
	templateBuilder.Append("\", 680, 450);\r\n                    </");
	templateBuilder.Append("script>\r\n                    ");
	}
	else
	{
	...
	templateBuilder.Append("\" class=\"cblue bold\">人气视频</a></div>\r\n            </div>\r\n            <div class=\"bcont w_235\" style=\"margin:0 0 6px 0;padding-bottom:6px;\">\r\n                <div class=\"phtlist2\">\r\n                    ");
	list = GetTable("content", "type=channel id=" + chnid.ToString() + " num=" +  "5" + " fields=id,typeid,savepath,filename,title,img,click order=" +  "3" + "");
	...
	templateBuilder.Append("</a><br />\r\n                            <span class=\"cgrey\">目前已有:<label class=\"cdarkgrey\">" + item["click"].ToString().Trim() + "</label>个人观看</span>\r\n                        </div>\r\n                    </div>\r\n                    ");
	}	//end loop

	templateBuilder.Append("  \r\n                  </div>\r\n            </div>\r\n            <div class=\"bbar w_235\">\r\n                <div class=\"tit\"><a href=\"");
	templateBuilder.Append(Urls.Channel(chnid).ToString().Trim());
	templateBuilder.Append("\" class=\"cblue bold\">推荐视频</a></div>\r\n            </div>\r\n            <div class=\"bcont w_235\" style=\"margin:0 0 6px 0;padding-bottom:6px;\">\r\n                <div class=\"phtlist3\">\r\n                    ");
