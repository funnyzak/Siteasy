...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string pageguide = Paging(1,"id,savepath,filename,title,click,img","",listcount,10,false,false,out datas);
	...
	templateBuilder.Append("</a></div>\r\n                        <div class=\"time cgrey\">目前已有:<label class=\"cdarkgrey\">" + item["click"].ToString().Trim() + "</label>个人观看</div>\r\n                    </div>\r\n                    ");
	}	//end loop
