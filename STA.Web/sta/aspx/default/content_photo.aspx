...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	if(info.Ext["ext_style"].ToString()=="3")
	{
	    AddLinkCss(tempurl + "/js/gallery/css/style.css");
	    AddLinkCss(tempurl + "/js/gallery/css/elastislide.css");
	}
	...
	templateBuilder.Append("</span>\r\n                        <span class=\"time\">更新时间：");	templateBuilder.Append(Convert.ToDateTime(Convert.ToDateTime(info.Updatetime)).ToString(" yyyy-MM-dd HH:mm:ss"));
	templateBuilder.Append("</span>\r\n                        <span class=\"conclick click\">");
	templateBuilder.Append(info.Click.ToString().Trim());
	templateBuilder.Append("人浏览</span>\r\n                        ");
	...
	templateBuilder.Append("\r\n                    ");
	if (info.Ext["ext_style"].ToString()=="1")
	{

	templateBuilder.Append("\r\n                    <div class=\"pth-show-1\">\r\n                    ");
	item__loop__id=0;
	foreach(DataRow item in list.Rows)
	{
		item__loop__id++;

	templateBuilder.Append("\r\n                        <div class=\"pth-show-1-itm\">\r\n                            <a class=\"a-pth-show-1\" rel=\"cimggroup\" href=\"" + item["url"].ToString().Trim() + "\" title=\"" + item["name"].ToString().Trim() + "\"><img src=\"" + item["url"].ToString().Trim() + "\" alt=\"" + item["name"].ToString().Trim() + "\"/></a><br />\r\n                            " + item["name"].ToString().Trim() + "\r\n                        </div>\r\n                    ");
	}	//end loop

	templateBuilder.Append("\r\n                    </div>\r\n                    <script type=\"text/javascript\">\r\n                        $('a[rel=cimggroup]').fancybox({\r\n	                    helpers: {\r\n	                        title: {\r\n	                            type: 'outside'\r\n	                        },\r\n	                        overlay: {\r\n	                            speedIn: 500,\r\n	                            opacity: 0.95\r\n	                        }\r\n	                    }\r\n	                });\r\n                    </");
	templateBuilder.Append("script>\r\n                    ");
	}
	else if (info.Ext["ext_style"].ToString()=="2")
	{

	templateBuilder.Append("\r\n                    <div class=\"pth-show-2 clearfix\">\r\n                    ");
	item__loop__id=0;
	foreach(DataRow item in list.Rows)
	{
		item__loop__id++;

	templateBuilder.Append("\r\n                        <div class=\"pth-show-2-itm\">\r\n                            <a class=\"a-pth-show-2\" rel=\"cimggroup\" href=\"" + item["url"].ToString().Trim() + "\" title=\"" + item["name"].ToString().Trim() + "\"><img src=\"" + item["url"].ToString().Trim() + "\" alt=\"" + item["name"].ToString().Trim() + "\"/><img src=\"" + item["url"].ToString().Trim() + "\" alt=\"" + item["name"].ToString().Trim() + "\"/></a>\r\n                        </div>\r\n                    ");
	}	//end loop
	...
	templateBuilder.Append("\r\n                   <div class=\"pth-show-3\">\r\n			            <div id=\"rg-gallery\" class=\"rg-gallery\">\r\n				            <div class=\"rg-thumbs\">\r\n					            <div class=\"es-carousel-wrapper\">\r\n						            <div class=\"es-nav\">\r\n							            <span class=\"es-nav-prev\">Previous</span>\r\n							            <span class=\"es-nav-next\">Next</span>\r\n						            </div>\r\n						            <div class=\"es-carousel\">\r\n							            <ul>\r\n                                            ");
	item__loop__id=0;
	foreach(DataRow item in list.Rows)
	{
		item__loop__id++;

	templateBuilder.Append("\r\n                                                <li><a href=\"#\"><img src=\"" + item["url"].ToString().Trim() + "\" data-large=\"" + item["url"].ToString().Trim() + "\" alt=\"" + item["id"].ToString().Trim() + "\" data-description=\"" + item["name"].ToString().Trim() + "\" /></a></li>\r\n                                            ");
	}	//end loop
	...
	templateBuilder.Append("\" class=\"cblue bold\">人气图集</a></div>\r\n            </div>\r\n            <div class=\"bcont w_235\" style=\"margin:0 0 6px 0;padding-bottom:6px;\">\r\n                <div class=\"phtlist2\">\r\n                    ");
	list = GetTable("content", "type=channel id=" + chnid.ToString() + " num=" +  "5" + " fields=id,typeid,savepath,filename,title,img,updatetime order=" +  "3" + "");
	...
	string hutime = ConUtils.HumanizeTime(item["updatetime"].ToString().Trim());
	...
	templateBuilder.Append("</a><br />\r\n                            <span class=\"cgrey\">最后更新于 <label class=\"cdarkgrey\">");
	templateBuilder.Append(hutime.ToString());
	templateBuilder.Append("</label></span>\r\n                        </div>\r\n                    </div>\r\n                    ");
	}	//end loop

	templateBuilder.Append("  \r\n                  </div>\r\n            </div>\r\n            <div class=\"bbar w_235\">\r\n                <div class=\"tit\"><a href=\"");
	templateBuilder.Append(Urls.Channel(chnid).ToString().Trim());
	templateBuilder.Append("\" class=\"cblue bold\">推荐图集</a></div>\r\n            </div>\r\n            <div class=\"bcont w_235\" style=\"margin:0 0 6px 0;padding-bottom:6px;\">\r\n                <div class=\"phtlist3\">\r\n                    ");
