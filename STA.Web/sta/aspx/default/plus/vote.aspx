<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="STA.Page.Plus.Vote" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	int wid = BarWid(item.Count,470,out prec);
	
	templateBuilder.Append("\r\n    	<div class=\"voteitem clearfix\">\r\n        	<div class=\"tit\">");
	templateBuilder.Append(item__loop__id.ToString());
	templateBuilder.Append("、");
	templateBuilder.Append(item.Content.ToString().Trim());
	...
	templateBuilder.Append("%</div>\r\n            ");
	            ...
	            string color = colors[(item__loop__id-1)%8];
	...
	templateBuilder.Append("\"></div>\r\n            <div class=\"count\">");
	templateBuilder.Append(item.Count.ToString().Trim());
	templateBuilder.Append("票</div>\r\n        </div>\r\n        ");
	}	//end loop

	templateBuilder.Append("\r\n    </div>\r\n    <div class=\"voteinfo\"> 投票开始时间:");	templateBuilder.Append(Convert.ToDateTime(info.StartDate).ToString(" yyyy-MM-dd"));
	templateBuilder.Append("&nbsp;&nbsp;&nbsp;投票结束时间:");	templateBuilder.Append(Convert.ToDateTime(info.EndDate).ToString(" yyyy-MM-dd"));
	templateBuilder.Append("&nbsp;&nbsp;&nbsp;总票数：");
	templateBuilder.Append(info.VoteTotalCount.ToString().Trim());
