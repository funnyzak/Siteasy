...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string pageguide = Paging(1,"id,savepath,filename,title,addtime,updatetime,img","",listcount,10,false,false,out datas);
	...
	templateBuilder.Append(tempurl.ToString());
	templateBuilder.Append("/images/pub/nopic.png'\" width=\"152\" height=\"112\"/></a>\r\n                        </div>\r\n                        <div class=\"txt\"><a href=\"");
	templateBuilder.Append(curl.ToString());
	templateBuilder.Append("\" title=\"" + item["title"].ToString().Trim() + "\" class=\"s13 cblue bold\">");	templateBuilder.Append(Utils.GetUnicodeSubString(item["title"].ToString().Trim(),20,".."));
	templateBuilder.Append("</a></div>\r\n                        <div class=\"time cgrey\">最后更新于 <span class=\"cdarkgrey\">");
