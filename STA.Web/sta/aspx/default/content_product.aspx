...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n                            <img src=\"" + item["url"].ToString().Trim() + "\" jqimg=\"" + item["url"].ToString().Trim() + "\" width=\"304\" height=\"297\">\r\n                            ");
	}	//end loop

	templateBuilder.Append("\r\n                        </div>\r\n                        <div id=\"spec-n5\">\r\n                            <div class=\"control\" id=\"spec-left\">\r\n                                <img src=\"");
	templateBuilder.Append(tempurl.ToString());
	templateBuilder.Append("/images/def/control-left.gif\" />\r\n                            </div>\r\n                            <div id=\"spec-list\">\r\n                                <ul class=\"list-h\">\r\n                                    ");
	item__loop__id=0;
	foreach(DataRow item in list.Rows)
	{
		item__loop__id++;
	...
	templateBuilder.Append("	\r\n                                    <li><img src=\"" + item["url"].ToString().Trim() + "\" id=\"" + item["id"].ToString().Trim() + "\" alt=\"" + item["name"].ToString().Trim() + "\"/></li>\r\n                                    ");
	}	//end loop

	templateBuilder.Append("\r\n                                </ul>\r\n                            </div>\r\n                            <div class=\"control\" id=\"spec-right\">\r\n                                <img src=\"");
	templateBuilder.Append(tempurl.ToString());
	templateBuilder.Append("/images/def/control-right.gif\" />\r\n                            </div>\r\n                        </div>\r\n                        </div>\r\n                    	<!--#preview End-->\r\n                    </div>\r\n                    <div class=\"softsummary\">\r\n                        <label>商品编号：</label><span>" + info.Ext["ext_code"].ToString().Trim() + "</span>\r\n                        <label>市场价：</label><span>" + info.Ext["ext_price"].ToString().Trim() + "元</span>\r\n                        <label>会员价：</label><span class=\"cred\">" + info.Ext["ext_vipprice"].ToString().Trim() + "元</span>\r\n                        <label>所属品牌：</label><span>" + info.Ext["ext_brand"].ToString().Trim() + "</span>\r\n                        <label>上架时间：</label><span>");	templateBuilder.Append(Convert.ToDateTime(Convert.ToDateTime(info.Ext["ext_ontime"].ToString().Trim())).ToString(" yyyy-MM-dd"));
	templateBuilder.Append("</span>\r\n                        <label>商品人气：</label><span class=\"conclick\">");
	templateBuilder.Append(info.Click.ToString().Trim());
	templateBuilder.Append("</span>\r\n                        <label>库存量：</label><span class=\"prodstorage\">" + info.Ext["ext_storage"].ToString().Trim() + "</span>\r\n                        <label>商品重量：</label><span>" + info.Ext["ext_weight"].ToString().Trim() + "KG</span>\r\n                        <label>购物车：</label><span><a href=\"");
	templateBuilder.Append(siteurl.ToString());
	templateBuilder.Append("/cart.aspx\" class=\"cblue\" target=\"_cart\">查看购物车</a></span>\r\n                        ");
	if (TypeParse.StrToInt(info.Ext["ext_storage"])>0)
	{

	templateBuilder.Append("\r\n                        <label class=\"buythis\">购买：</label><span style=\"cursor:pointer;\" onclick=\"shopCart.setProduct({ id: '");
	templateBuilder.Append(info.Id.ToString().Trim());
	templateBuilder.Append("', num: 0, price: " + info.Ext["ext_vipprice"].ToString().Trim() + " });alert('成功加入购物车！');\" class=\"buythis cblue\">加入购物车</span>\r\n                        ");
	}	//end if
	...
	string vstr = UBB.ParseMedia("flv", 680, 450, true, info.Ext["ext_vfile"].ToString().Trim());
	
	templateBuilder.Append("\r\n				<div class=\"info-intro fyahei s16 bold\">视频介绍</div>\r\n                <div class=\"pcontent\" style=\"width:670px;padding-left:10px;\">\r\n                     ");
	templateBuilder.Append(vstr.ToString());
	templateBuilder.Append("\r\n                </div>\r\n                ");
	}	//end if
	...
	templateBuilder.Append(info.Id.ToString().Trim());
	templateBuilder.Append(",\"product\",\"storage\",function(c){ $(\".prodstorage\").html(c); if(parseInt(c)<=0){ $(\".buythis\").remove();} });\r\n            </");
	...
	templateBuilder.Append("\" class=\"cblue bold\">热卖商品</a></div>\r\n            </div>\r\n            <div class=\"bcont w_235\" style=\"margin:0 0 6px 0;padding-bottom:6px;\">\r\n                <div class=\"phtlist2\">\r\n                    ");
	list = GetTable("content", "type=channel ctype=4 ext=product id=" + chnid.ToString() + " num=" +  "5" + " fields=id,savepath,filename,title,img,ext_vipprice order=" +  "3" + "");
	...
	templateBuilder.Append("</a><br />\r\n                            <span class=\"cgrey\">产品售价:<label class=\"cdarkgrey\">" + item["ext_vipprice"].ToString().Trim() + "</label>元</span>\r\n                        </div>\r\n                    </div>\r\n                    ");
	}	//end loop

	templateBuilder.Append("  \r\n                  </div>\r\n            </div>\r\n            <div class=\"bbar w_235\">\r\n                <div class=\"tit\"><a href=\"");
	templateBuilder.Append(Urls.Channel(chnid).ToString().Trim());
	templateBuilder.Append("\" class=\"cblue bold\">推荐商品</a></div>\r\n            </div>\r\n            <div class=\"bcont w_235\" style=\"margin:0 0 6px 0;padding-bottom:6px;\">\r\n                <div class=\"phtlist3\">\r\n                    ");
	list = GetTable("content", "type=channel id=" + chnid.ToString() + " num=" +  "2" + " fields=id,typeid,savepath,filename,title,img,updatetime order=" +  "2" + " property=r");
	...
	templateBuilder.Append("\" onerror=\"this.src='");
	templateBuilder.Append(tempurl.ToString());
	templateBuilder.Append("/images/pub/nopic.png'\"/></a></div>\r\n                        <div class=\"txt\"><a href=\"");
	templateBuilder.Append(curl.ToString());
	templateBuilder.Append("\" title=\"" + item["title"].ToString().Trim() + "\" class=\"cgrey s13\">");	templateBuilder.Append(Utils.GetUnicodeSubString(item["title"].ToString().Trim(),14,""));
	...
	templateBuilder.Append("    \r\n        </div>\r\n    </div>\r\n	<script src=\"");
	templateBuilder.Append(tempurl.ToString());
	templateBuilder.Append("/js/zoom/zoom.lib.js\" type=\"text/javascript\"></");
	templateBuilder.Append("script>\r\n    <script src=\"");
	templateBuilder.Append(tempurl.ToString());
	templateBuilder.Append("/js/zoom/zoom-css.js\" type=\"text/javascript\"></");
