<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="STA.Page.Tags" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	list = GetTable("content", "type=tag id=" + id.ToString() + " num=" +  "10000" + " fields=id,title,typeid,channelid,channelname,content,savepath,filename,addtime,img,click,commentcount order=" +  "0" + "");
