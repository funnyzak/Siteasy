 ...
 * @param   {Function}              (可选) 回调函数
 */
$.dialog.tip = function (content, time, callback) {
    return $.dialog({
        id: "tip",
        title: false,
 ...
 */
$.dialog.prompt = function (content, ok, defaultValue) {
