...
(function () {
    ...
    */
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        , imageUrl: "/useraction.aspx?action=ueditorimgup"             //图片上传提交地址
        , imagePath: ""                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //,imageFieldName:"uedimgfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //附件上传配置区
        , fileUrl: "/useraction.aspx?action=ueditorattup"               //附件上传提交地址
        ...
        //图片在线管理配置区
        , imageManagerUrl: "/useraction.aspx?action=ueditorimgmanage"       //图片在线管理的处理地址
