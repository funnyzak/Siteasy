    ...
    var addonDialog = function (editor, dialogType) {
        return {
            ...
            onOk: function () {
                ...
                var tempvar = '<table width="550" class="attachment">\r    <tbody>\r        <tr>\r            <td style="width:20px;height:30px;border:0;"><a target="_blank" href="' + addonUrl + '"><img border="0" align="middle" src="/sta/pics/attach2.gif" alt="' + addonTitle + '" /></a></td>\r            <td style="border:0;"><a target="_blank" href="' + addonUrl + '" class="attach"><u>' + addonTitle + '</u></a></td>\r        </tr>\r    </tbody>\r</table>';
