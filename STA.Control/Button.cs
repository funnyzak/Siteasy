...
namespace STA.Control
{
    ...
    public class Button : WebControl, IPostBackEventHandler
    {
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            this.CssClass = this.CssClass.Trim() == string.Empty ? "\"ManagerButton\"" : this.CssClass;
            if (this.AutoPostBack)
            {
                ...
                {
                    output.Write("<span " + this.Wrapper + "><button type=\"button\" title=\"" + this.HelpText + "\" class=" + this.CssClass + " id=\"" + this.UniqueID + "\"" + buttonEnabled + " onclick=\"" + sb.ToString() + "\">" + this.Text + "</button></span>");
                }

                if (this.ButtontypeMode == ButtonType.WithImage)
                {
                    output.Write("<span " + this.Wrapper + "><button type=\"button\" title=\"" + this.HelpText + "\" class=" + this.CssClass + " id=\"" + this.UniqueID + "\"" + buttonEnabled + " onclick=\"" + sb.ToString() + "\"><img src=\"" + this.ButtonImgUrl + "\"/>" + this.Text + "</button></span>");
                }
            ...
            else
            {
                if (this.ButtontypeMode == ButtonType.Normal)
                {
                    output.Write("<span " + this.Wrapper + "><button type=\"button\" title=\"" + this.HelpText + "\" class=" + this.CssClass + " id=\"" + this.UniqueID + "\"" + buttonEnabled + " onclick=\"" + this.OnClientClick + ScriptContent + "\">" + this.Text + "</button></span>");
                }

                if (this.ButtontypeMode == ButtonType.WithImage)
                {
                    output.Write("<span " + this.Wrapper + "><button type=\"button\" title=\"" + this.HelpText + "\" class=" + this.CssClass + " id=\"" + this.UniqueID + "\"" + buttonEnabled + " onclick=\"" + this.OnClientClick + ScriptContent + "\"><img src=\"" + this.ButtonImgUrl + "\"/>" + this.Text + "</button></span>");
                }
            }
        ...
        /// 要加载的客户端脚本内容
        /// </summary>
        [Description("onclick附加脚本"), DefaultValue("")]
