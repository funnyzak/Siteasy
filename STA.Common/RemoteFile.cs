...
namespace STA.Common
{
    ...
    public class RemoteResource
    {
        ...
        public RemoteResource(string Content, string LocalURLDirectory, bool RenameFile)
        {
            _content = Content;
    ...
    public class RemoteFile
    {
        ...
        /// <returns></returns>
        public static String Remote(String Content, string[] FileExtends, string savepath)
        {
            try
            {
                String path = savepath + DateTime.Now.Year + "/" + DateTime.Now.Month;
                RemoteResource red = new RemoteResource(Content, path, true);
        ...
        public static String Remote(string Content, string savepath)
        {
            ...
            return Remote(Content, deflist, savepath);
        }

        public static String Remote(string Content)
        {
            // "gif", "jpg", "bmp", "ico", "png", "jpeg", "swf", "rar", "zip", "cab", "doc", "rm", "ram", "wav", "mid", "mp3", "avi", "wmv"
            return Remote(Content, deflist, "/");
        }
    }
}
