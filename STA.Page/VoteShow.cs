...
namespace STA.Page
{
    public class VoteShow : PageBase
    {
        public DataTable votelist;
        public string vtype = STARequest.GetString("vtype"); //获取方式  ids集合(ids)  标识列(like)
        public string relval = STARequest.GetString("relval"); //相关值
