...
namespace STA.Plugin.Mail
{
    ...
    /// Discuz!NT邮件发送程序
    /// </summary>
    [SmtpEmail("DNT邮件发送程序", Version = "2.0", Author = "Discuz!NT ", DllFileName = "STA.Plugin.dll")]
	public class SmtpMail: ISmtpMail
	{
		...
		private bool SendEmail()
		{
			...
			*/
            ...
            SendBufferstr += "To:=?" + Charset.ToUpper() + "?B?" + (STA.Common.Utils.StrIsNullOrEmpty(RecipientName) ? "" : Base64Encode(RecipientName)) + "?=" + "<" + Recipient[0] + ">" + enter;
