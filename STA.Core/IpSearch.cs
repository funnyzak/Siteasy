...
namespace STA.Core
{
    ...
    {
        static FileStream ipFile;
        static long ip;
        static string ipfilePath;
        ...
        static IPSearch()
        {
            ipfilePath = Utils.GetMapPath(BaseConfigs.GetSitePath + "/sta/data/database/ipadr.config");
        }
        ...
        public static IPLocation GetIPLocation(string strIP)
        {
            ...
            if (Utils.InArray(loc.country.Trim(), "局域网,本机地址")) loc.area = "";
            ipFile.Close();
            ipFile = null;
            return loc;
        }
        ...
        static long[] BlockToArray(byte[] ipBlock)
        {
        ...
        ///<returns></returns>
        static int SearchIP(long[] ipArray, int start, int end)
        {
        ...
        ///<returns></returns>
        static long ReadLongX(int bytesCount)
        {
        ...
        ///<returns></returns>
        static string ReadString(int flag)
        {
